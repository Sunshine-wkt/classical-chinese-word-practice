...
/* 第十篇：三段指定節錄沿用紙本閱讀脊線，手機頂欄優先保留篇名、進度與返回目錄。 */
@media(max-width:650px){
  .bar{align-items:center;gap:8px;padding:9px 12px}
  .brand{flex:1;max-width:none;gap:7px;font-size:.85rem;letter-spacing:.02em;line-height:1.2}
...
fs.writeFileSync(path.join(projectRoot, 'client/public/quanxue-interactive.html'), html);
